...
op_20_in <- \(...) {
  ...
  ###::
  loglines <<- c(loglines, " ", (paste0("!!:: `in` (opcode 20) received this string input: { *", str, "* } and is now parsing.")), " ")
